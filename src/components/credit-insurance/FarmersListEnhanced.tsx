...
export const FarmersListEnhanced = () => {
  ...
  // Export to PDF (simplified - would need a proper PDF library for production)
                        ...
                        <TableRow key={farmer.id}>
                          ...
                          <TableCell className="text-right">
                            {farmer.cultivated_area_ha ? (
                              <span className="font-medium">{farmer.cultivated_area_ha.toLocaleString()}</span>
                            ) : (
                              <span className="text-muted-foreground">—</span>
                            )}
                          </TableCell>
                          ...
                          <TableCell className="text-right">
                            <Link to={`/credito-seguro/perfil/${farmer.id}`}>
