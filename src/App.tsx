...
import ForestOccurrencesPage from "./pages/forestry/ForestOccurrencesPage";
import ForestryFiresPage from "./pages/forestry/ForestryFiresPage";
import ForestryPestsPage from "./pages/forestry/ForestryPestsPage";
import CompanionDevicesPage from "./pages/admin/CompanionDevicesPage";
import NFCCardsPage from "./pages/admin/NFCCardsPage";
import FieldCapturesAuditPage from "./pages/admin/FieldCapturesAuditPage";
